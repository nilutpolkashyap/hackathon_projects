// Leg Tapping Detection System


#include <Adafruit_MPU6050.h>
//#include <Adafruit_Sensor.h>
#include <Wire.h>
#include <leg_shaking_recognition_inferencing.h>
...
//      ei_printf(": \n");
      ...
      for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
        ...
        if (result.classification[ix].value > 0.6) {
          if (result.classification[ix].label == "left-right-shake")
          {
//            digitalWrite(RED, HIGH);
//            digitalWrite(GREEN, LOW);
//            digitalWrite(BLUE, LOW);
              Serial.println(result.classification[ix].label);
          } else if (result.classification[ix].label == "up-down-shake")
          {
